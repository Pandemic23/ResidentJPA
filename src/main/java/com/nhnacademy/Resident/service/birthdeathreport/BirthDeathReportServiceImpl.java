...
import com.nhnacademy.Resident.repository.birthdeath.BirthDeathReportResidentRepository;
...
public class BirthDeathReportServiceImpl implements BirthDeathReportService {
    ...
    public BirthReportResponse birthRegister(Long serialNumber, BirthReportRegisterRequest request) {
        ...
        BirthDeathReportResident birthReport =
                extractBirthReport(serialNumber, request, targetResident, birthReportQualificationsCode);
    ...
    private BirthDeathReportResident extractBirthReport(Long serialNumber, BirthReportRegisterRequest request,
                                                        Resident targetResident, String birthReportQualificationsCode) {
    ...
    private void updateBirthReport(BirthReportEditRequest request, BirthDeathReportResident birthReport,
    ...
    public DeathReportResponse deathRegister(Long serialNumber, DeathReportRegisterRequest request) {
        ...
        BirthDeathReportResident deathReport =
                extractDeathReport(serialNumber, request, targetResident, deathReportQualificationsCode);
    ...
    private BirthDeathReportResident extractDeathReport(Long serialNumber, DeathReportRegisterRequest request,
                                                        Resident targetResident, String deathReportQualificationsCode) {
        return BirthDeathReportResident.builder()
    ...
    private void updateDeathReportInfo(DeathReportEditRequest request, BirthDeathReportResident deathReport,
