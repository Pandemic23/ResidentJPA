...
import com.nhnacademy.Resident.exception.HouseholdAddressNotFoundException;
import com.nhnacademy.Resident.exception.HouseholdMemberNotFoundException;
...
import com.nhnacademy.Resident.repository.household.HouseholdCompositionResidentRepository;
import com.nhnacademy.Resident.repository.household.HouseholdMovementAddressRepository;
import com.nhnacademy.Resident.repository.household.HouseholdRepository;
...
public class HouseholdServiceImpl implements HouseholdService {
    ...
    public List<HouseholdMemberViewResponse> getHouseholdMembers(Long householdSerialNumber) {
        List<HouseholdMemberViewResponse> householdMembers =
                householdCompositionResidentRepository.getAllMembers(householdSerialNumber);
    ...
    public List<HouseholdMovementAddress> getMovementAddresses(Long householdSerialNumber) {
        List<HouseholdMovementAddress> addressList =
                hmaRepository.findAllByHousehold_HouseholdSerialNumberOrderByPk_HouseMovementReportDateDesc(
    ...
    public HouseholdResponse registerHousehold(HouseholdRegisterRequest request) {
        ...
        HouseholdCompositionResident compositionResident =
                extractCompositionResident(request, householdResident, household);
    ...
    private HouseholdCompositionResident extractCompositionResident(HouseholdRegisterRequest request,
                                                                    Resident householdResident, Household household) {
        return HouseholdCompositionResident.builder()
                .pk(new HouseholdCompositionResident.Pk(request.getHouseholdSerialNumber(),
                        request.getHouseholdResidentSerialNumber()))
    ...
    @Override
    public HouseholdMemberResponse registerHouseholdMember(Long householdSerialNumber,
        ...
        HouseholdCompositionResident householdComposition =
                extractHouseholdComposition(householdSerialNumber, request, householdMember, household);
    ...
    private HouseholdCompositionResident extractHouseholdComposition(Long householdSerialNumber,
                                                                     HouseholdMemberRegisterRequest request,
                                                                     Resident householdMember, Household household) {
        return HouseholdCompositionResident.builder()
                .pk(new HouseholdCompositionResident.Pk(householdSerialNumber,
                        request.getHouseholdResidentSerialNumber()))
    ...
    public void deleteHouseholdMember(Long householdSerialNumber, Long householdResidentSerialNumber) {
        HouseholdCompositionResident.Pk id =
                new HouseholdCompositionResident.Pk(householdSerialNumber, householdResidentSerialNumber);
        householdCompositionResidentRepository.deleteById(id);
    }

    @Override
    public HouseholdMovementResponse registerHouseholdMovement(Long householdSerialNumber,
        ...
        HouseholdMovementAddress movementAddress =
                extractHouseholdMovementAddress(householdSerialNumber, request, household);
    ...
    private HouseholdMovementAddress extractHouseholdMovementAddress(Long householdSerialNumber,
                                                                     HouseholdMovementRegisterRequest request,
                                                                     Household household) {
        return HouseholdMovementAddress.builder()
    ...
    @Override
    public HouseholdMovementResponse editHouseholdMovement(Long householdSerialNumber, LocalDateTime reportDate,
    ...
    private HouseholdMovementAddress getHouseholdMovementAddress(Long householdSerialNumber, LocalDateTime reportDate) {
        Optional<HouseholdMovementAddress> optionalAddress =
                hmaRepository.findById(new HouseholdMovementAddress.Pk(reportDate, householdSerialNumber));
